...
class TestApiV1:
    ...
    def test_list_users(self, api_url, page_num, expected_count):
    ...
    def test_single_user_not_found(self, api_url, user_id):
        response = requests.get(f"{api_url}/users/{user_id}")
        assert response.status_code == 404

    def test_create_user(self, api_url, user_data):
        data=user_data
    ...
    def test_update_user(self, api_url, user_data, user_id):
        data=user_data
